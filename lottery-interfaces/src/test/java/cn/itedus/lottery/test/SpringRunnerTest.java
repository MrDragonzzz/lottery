...
public class SpringRunnerTest {
    ...
    public void test_award() {
        ...
        GoodsReq goodsReq = new GoodsReq(drawResult.getuId(), Long.getLong("2109313442431"), drawAwardInfo.getAwardId(), drawAwardInfo.getAwardName(), drawAwardInfo.getAwardContent());
